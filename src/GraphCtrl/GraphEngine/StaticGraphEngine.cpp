...
@File: StaticGraphEngine.cpp
@Time: 2022/12/01 21:41 下午
@Desc: 
***************************/

#include "StaticGraphEngine.h"

CGRAPH_NAMESPACE_BEGIN

CStatus StaticGraphEngine::init() {
...
CStatus StaticGraphEngine::process() {
    CGRAPH_FUNCTION_BEGIN
...
CStatus StaticGraphEngine::preRunCheck() {
    CGRAPH_FUNCTION_BEGIN
...
CStatus StaticGraphEngine::analyse() {
    CGRAPH_FUNCTION_BEGIN
